...
(displayln
 (format "Find the Elf carrying the most Calories. How many total Calories is that Elf carrying?~n~a"
         (apply + (flatten (take calorie-ranking 1)))))
(newline)

(displayln
 (format "Find the top three Elves carrying the most Calories. How many Calories are those Elves carrying in total?~n~a"
         (apply + (flatten (take calorie-ranking 3)))))
